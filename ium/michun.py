...
from sele.webdriver.common.by import By
from appium.webdriver.extensions.android.nativekey import AndroidKey

desired_caps = {
  'platformName': 'Android', # 被测手机是安卓
  'platformVersion': '12', # 手机安卓版本
  'deviceName': 'Mi 11', # 设备名，安卓手机可以随意填写
  'appPackage': 'com.donglizu.michun', # 启动APP Package名称
  'appActivity': 'com.donglizu.michun.MainActivity', # 启动Activity名称
